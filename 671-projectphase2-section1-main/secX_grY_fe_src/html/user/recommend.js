$(document).ready(() => {
    ...
    fetch('http://localhost:3030/api/recommend')
        .then(response => {
            if (!response.ok) {
        ...
        .then(data => {
            ...
            try {
                ...
                $("#productlist_recommend .products").html('<p>Error loading products. Please try again later.</p>');
            }
        })
        .catch(error => {
    ...
    function renderProducts(products) {
        ...
        $("#productlist_recommend .products").html(html);
    }
